...
rsync -rltJOve ssh --partial --progress --delete --exclude *.cme --exclude stage1*.tar* --exclude stage2*.tar* --exclude *.tar $mp/1.4-release-std/ drobbins@upload.funtoo.org:/home/mirror/funtoo/1.4-release-std/
rsync -rltJOve ssh --partial --progress --delete --exclude *.cme --exclude stage1*.tar* --exclude stage2*.tar* --exclude *.tar $mp/livecd drobbins@upload.funtoo.org:/home/mirror/funtoo/
